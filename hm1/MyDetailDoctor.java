...
public class MyDetailDoctor {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MyDetailDoctor window = new MyDetailDoctor();
	...
	private void initialize() {
		...
		JLabel lblProblem = new JLabel("Specility");
		...
		try{
			...
			if(rs.next()) {
				...
				String specility=rs.getString(7);
