...
public class StaffRegister extends JFrame{
	...
	private void initialize() {
		...
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"RECIPTIONIST", "NURSE", "WARD BOY", "CLEANERS"}));
		comboBox_1.setBounds(107, 281, 137, 20);
		...
		btnRegister.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String post = comboBox_1.getSelectedItem().toString();
				...
				int staffid = 0;
				staffid = (int) ((Math.random() * 9000) + 1000);
				
				if (found == 0) {
				int i = StaffDao.register(staffid, fname, lname, gender, dob, bloodgrp, post, phno1, phno2, email, address, city,password);
				if (i > 0 && found == 0) {
					JOptionPane.showMessageDialog(StaffRegister.this,
							"Staff ID is:" + staffid + " Staff added successfully!");
				} else {
					JOptionPane.showMessageDialog(StaffRegister.this, "Sorry, unable to register!");
				}
				}
				 else {
						JOptionPane.showMessageDialog(StaffRegister.this, "Sorry, unable to register!");
